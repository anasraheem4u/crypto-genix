    ...
    const checkAdminAndFetchData = async () => {
      ...
      try {
        ...
        if (!adminData.isAdmin) {
          ...
          const debugInfo = adminData.debug ? ` (User: ${adminData.debug.email}, ID: ${adminData.debug.userId}, Key: ${adminData.debug.serviceKeyPresent})` : '';
          setError(`Unauthorized: Admin access required.${debugInfo}`);
          setIsAdmin(false);
          setLoading(false);
          return;
        }
