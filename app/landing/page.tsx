      ...
      <nav className="sticky top-0 z-50 w-full border-b border-dark-border bg-dark-card/80 backdrop-blur-md">
        <div className="flex h-16 items-center justify-between px-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-blue-accent">Crypto Genix</span>
          </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-blue-accent/70 mb-8 max-w-2xl mx-auto">
                Join thousands of traders and investors who trust Crypto Genix for their
                trading needs.
              </p>
              <Link
                href="/signin"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-blue-accent">Crypto Genix</span>
            </div>
            <div className="text-blue-accent/70 text-sm">
              © 2025 Crypto Genix. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
